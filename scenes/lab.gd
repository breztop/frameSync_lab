...
func _ready() -> void:
	...
	$Interface/AboutPanel/Panel/Margin/Content/Identity/VersionBadge/Version.text = "v" + str(ProjectSettings.get_setting("application/config/version", "0.12"))
...
func _config() -> Dictionary:
	...
	return {"mode": MODES[controls.mode.selected], "mode_index": controls.mode.selected,
		...
		"app_version": ProjectSettings.get_setting("application/config/version", "0.12"),
